...
var navigation = [
    ...
    { name: 'Sex Chat', href: 'https://play.google.com/store/apps/details?id=com.bhola.realvideochat1&hl=en-IN', current: false },
    ...
    return (
        ...
        <div className='font-inter'>
            ...
            <div className='flex justify-around items-center mb-1 bg-blue-100 shadow-lg lg:hidden font-arial px-2'>
                ...
                <Link href='https://play.google.com/store/apps/details?id=com.bhola.realvideochat1&hl=en-IN'>
